...
public class AdminEditController extends HttpServlet {
    ...
    private final String HOME = "admin_editAd.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String roleName = (String) request.getParameter("rName");

            if (roleName.equals("Revenue")) {
                admindao.UpdateRoleByUsername(username, "RE");
            } else {
                admindao.UpdateRoleByUsername(username, "US");
            }

            url = SUCCESS;

        } catch (Exception e) {
            log("ERROR at AdminChangeStatus " + e.toString());
        } finally {
