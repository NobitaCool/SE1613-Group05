                                            ...
                                            <tr>
                                                ...
                                                <td class="txt-md ">
                                                    <div class="flexStatus">
                                                        ...
                                                        <div>
                                                            <select class="form-select " name="DeliveryStatus" aria-label="Default select example" onchange="this.form.submit()">
                                                ...
                                                <td class="txt-md ">
                                                    <!--<button type="submit" name="action" value="Update_Delivery">Update Status</bu //tton>-->
